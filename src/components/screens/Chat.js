...
export default class ChatRoom extends Component {
  ...
  getChatRoomId = async () => {
    ...
    console.log("currentUserRoomIds, selectedUsersRoomIds", currentUserRoomIds, selectedUsersRoomIds);
  ...
  getRoomUsers = async () => {
    let roomUsers;
    // console.log("In Chat Component selected users",this.selectedUsers);
    ...
    console.log("in component chat roomuser",roomUsers)
    return roomUsers;
  }
